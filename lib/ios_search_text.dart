...
/// 右侧清除按钮 X 被点击的回调
typedef OnTextClear = bool Function();

/// 基本IOS风格搜索框, 提供输入回调
class IOSSearchText extends StatefulWidget {
  /// 提示语
...
class _SearchTextState extends State<IOSSearchText> {
  FocusNode? focusNode;
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: TextField(
                          ...
                          cursorColor: BaseThemeConfig.instance
                              .getConfig()
                              .commonConfig
                              .brandPrimary,
                          cursorWidth: 2.0,
